...
def getSoftConstraintScore(population):
    ...
    criteria_3a = groupConsecutive == 5
    fitness3[criteria_3a] = 4
    criteria_3b = groupConsecutive == 4
    fitness3[criteria_3b] = 2
    criteria_3c = groupConsecutive == 3
    fitness3[criteria_3c] = 1
...
def saveToExcel(sheets):
    with pd.ExcelWriter("GAFive.xlsx") as writer:
...
if __name__ == "__main__":
    ...
    df = pd.read_excel("GAFive.xlsx", sheet_name=None)
